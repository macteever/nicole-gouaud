			...
			<footer class="footer" role="contentinfo">
				<div class="container-fluid" id="contact">
					<div class="container">
						<div class="row">
							<div class="col-xl-4 col-lg-4 col-md-4 col-12 lekton fs-16 footer-block">
								<?php if ( !function_exists('dynamic_sidebar') || !dynamic_sidebar('Widget Area 1', 'html5blank') )?>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-4 col-12 footer-block">
							...
							<div class="col-xl-4 col-lg-4 col-md-4 col-12 lekton fs-16 text-right footer-block">
